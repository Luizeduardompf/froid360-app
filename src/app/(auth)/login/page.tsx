...
export default function LoginPage() {
  ...
  async function onSubmit(data: FormData) {
    ...
    // Simula erro de credenciais inválidas para demo
    if (data.email !== 'demo@froid.app') {
      setServerError('E-mail ou senha incorretos. Use demo@froid.app para testar.');
      return;
    }
  ...
  return (
    <main className="flex flex-col min-h-screen px-6 py-10">
      ...
      <div className="mb-10 mt-8">
        <div className="w-12 h-12 rounded-2xl bg-primary flex items-center justify-center mb-4 shadow">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <input
            ...
            className={cn(
              ...
              errors.email ? 'border-destructive focus:ring-destructive/40 focus:border-destructive' : 'border-border'
            )}
          />
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative">
            <input
              ...
              placeholder="••••••••"
              className={cn(
                'w-full px-4 py-3 pr-11 rounded-xl border bg-card text-foreground text-sm outline-none',
                'focus:ring-2 focus:ring-primary/40 focus:border-primary transition-all',
                errors.password ? 'border-destructive focus:ring-destructive/40 focus:border-destructive' : 'border-border'
              )}
            />
            <button
              type="button"
        ...
        <Link href="#" className="text-primary text-xs text-right -mt-1">Esqueci a senha</Link>
        ...
        <button
          type="button"
          className="w-full flex items-center justify-center gap-3 py-3.5 rounded-2xl border border-border bg-card font-medium text-sm text-foreground hover:bg-muted active:scale-[0.98] transition-all"
        >
